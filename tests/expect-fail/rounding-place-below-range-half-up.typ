// Rounding a value near the largest decimal to a place far above the point asks
...
// expect: format-number: the answer 28 places above the point is larger than a decimal holds
...
#repr(round-decimal(decimal("79228162514264337593543950335"), -28, "half-up"))
