...
#import "src/locations.typ": (
  cells-body, cells-column-labels, cells-column-spanners, cells-footnotes, cells-grand-summary,
  cells-row-groups, cells-source-notes, cells-stub, cells-stubhead, cells-summary, cells-title,
)
